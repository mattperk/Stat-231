...
> RESPONSE: There are 1846 rows and 3 columns. The variables are dataset, x, and y.
...
> RESPONSE: The points mapped by the x and y data together form the shape of a dinosaur.
...
> RESPONSE: The r value is -0.0629611, which is very similar to the weak correlation coefficient seen with the 'dino' dataset.	
...
> RESPONSE: Unlike the dino plot, the star dataset has points arranged in the shape of a star on a plot of y vs. x.
...
> RESPONSE: The plot of y vs. x for the circle dataset looks like a circle, which is different from either of the two prior datasets.
...
> RESPONSE: The correlation coefficient is approximately the same for all of these datasets, but the data themselves all have extremely different patterns from one another. This shows that the correlation coefficient is a very poor summary for these datasets since it provides too little information to provide an understanding of the data.
