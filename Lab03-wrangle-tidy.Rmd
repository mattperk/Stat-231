...
> RESPONSE: The values on the x-axis will come from the spending data from 2013-2014 by state, and the values on the y-axis will come from the coverage data from 2013-2014 by state.

What are some of the steps that will need to be taken to get the data in that form?  

> RESPONSE: The data will need to be filtered to include only those years and be able to map points corresponding to the same states between the datasets.
