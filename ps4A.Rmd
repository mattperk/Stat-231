...
```{r}
# you may need to install the robotstext package if you're 
# on your machine and haven't used it before
library(robotstxt)
...
> ANSWER: Genzebe Dibaba holds the indoor one-mile record for IAAF women, with a time of 4:13.31.
...
> ANSWER: THe fastest record is from an outdoor event, and is 4:12.33 by 
Sifan Hassan.
